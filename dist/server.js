...
(() => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        app.listen(config_1.default.PORT, () => {
            winston_1.logger.info(`Server akouei sta:http://localhost:${config_1.default.PORT}`);
        });
    }
    catch (err) {
...
const handleServerShutdown = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        winston_1.logger.warn('Server eixame');
        process.exit(0);
    }
    catch (err) {
        winston_1.logger.error('Error sto kleisimo tou server', err);
    }
});
